...
public protocol LightningNodeProtocol {
    ...
    func `registerNotificationToken`(`notificationToken`: String, `language`: LanguageCode, `country`: CountryCode)  throws
...
public class LightningNode: LightningNodeProtocol {
    ...
    public func `registerNotificationToken`(`notificationToken`: String, `language`: LanguageCode, `country`: CountryCode) throws {
        try 
    rustCallWithError(FfiConverterTypeLnError.lift) {
    uniffi_lipalightninglib_fn_method_lightningnode_register_notification_token(self.pointer, 
        ...
        FfiConverterTypeLanguageCode.lower(`language`),
        FfiConverterTypeCountryCode.lower(`country`),$0
    )
}
    }
}
...
public struct FfiConverterTypeCountryCode: FfiConverterRustBuffer {
    ...
    public static func write(_ value: CountryCode, into buf: inout [UInt8]) {
        ...
        case .`tca`:
            writeInt(&buf, Int32(230))
        
        
        case .`tuv`:
            writeInt(&buf, Int32(231))
        
        
        case .`uga`:
            writeInt(&buf, Int32(232))
        
        
        case .`ukr`:
            writeInt(&buf, Int32(233))
        
        
        case .`are`:
            writeInt(&buf, Int32(234))
        
        
        case .`gbr`:
            writeInt(&buf, Int32(235))
        
        
        case .`usa`:
            writeInt(&buf, Int32(236))
        
        
        case .`umi`:
            writeInt(&buf, Int32(237))
        
        
        case .`ury`:
            writeInt(&buf, Int32(238))
        
        
        case .`uzb`:
            writeInt(&buf, Int32(239))
        
        
        case .`vut`:
            writeInt(&buf, Int32(240))
        
        
        case .`ven`:
            writeInt(&buf, Int32(241))
        
        
        case .`vnm`:
            writeInt(&buf, Int32(242))
        
        
        case .`vgb`:
            writeInt(&buf, Int32(243))
        
        
        case .`vir`:
            writeInt(&buf, Int32(244))
        
        
        case .`wlf`:
            writeInt(&buf, Int32(245))
        
        
        case .`esh`:
            writeInt(&buf, Int32(246))
        
        
        case .`yem`:
            writeInt(&buf, Int32(247))
        
        
        case .`zmb`:
            writeInt(&buf, Int32(248))
        
        
        case .`zwe`:
            writeInt(&buf, Int32(249))
...
public func FfiConverterTypeCountryCode_lift(_ buf: RustBuffer) throws -> CountryCode {
    return try FfiConverterTypeCountryCode.lift(buf)
}
...
extension CountryCode: Equatable, Hashable {}
...
public struct FfiConverterTypeLanguageCode: FfiConverterRustBuffer {
    typealias SwiftType = LanguageCode

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LanguageCode {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: LanguageCode, into buf: inout [UInt8]) {
        switch value {
...
public func FfiConverterTypeLanguageCode_lift(_ buf: RustBuffer) throws -> LanguageCode {
    return try FfiConverterTypeLanguageCode.lift(buf)
}

public func FfiConverterTypeLanguageCode_lower(_ value: LanguageCode) -> RustBuffer {
    return FfiConverterTypeLanguageCode.lower(value)
}


extension LanguageCode: Equatable, Hashable {}
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi__checksum_method_lightningnode_register_notification_token() != 60328) {
        return InitializationResult.apiChecksumMismatch
    }
